...
from mountain_peaks.models import Location, MountainPeak
...
class MountainPeaksTestCase(TestCase):
    ...
    def setUpTestData(cls):
        mont_blanc_location = Location.objects.create(coordinates=Point(x=6.865575, y=45.832119))
        cls.mont_blanc = MountainPeak.objects.create(name="Mont Blanc", altitude=4_696, location=mont_blanc_location)
